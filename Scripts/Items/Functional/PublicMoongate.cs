...
namespace Server.Items
{
    public class PublicMoongate : Item
    {
        ...
        public static void MoonGen_OnCommand(CommandEventArgs e)
        {
            DeleteAll();
            int count = 0;
            count += MoonGen(PMList.Felucca); // Solo Felucca!
    ...
    public class PMList
    {
        // Solo Felucca tra le destinazioni
        public static readonly PMList Felucca =
            new PMList(1012001, 1012013, Map.Felucca, new PMEntry[]
            {
                ...
                new PMEntry(new Point3D(3563, 2139, Map.Felucca.GetAverageZ(3563, 2139)), 1012010), // Magincia
                new PMEntry(new Point3D(2711, 2234, 0), 1019001)  // Buccaneer's Den
            });

        // Alias per compatibilità con altri script
        // this is only for compatibility
        public static readonly PMList Trammel = Felucca;
        public static readonly PMList Malas = Felucca;

        // Tutte le liste ora sono solo Felucca
    ...
    public class MoongateGump : Gump
    {
            ...
            : base(100, 100)
        {
            ...
            // Mostra sempre e solo Felucca in ogni caso
            PMList[] checkLists = PMList.UORLists;
