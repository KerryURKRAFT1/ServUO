...
{ 
    public class OrcCamp : BaseCamp
    {
        ...
        public override void AddComponents()
        {
            ...
            for (int i = 0; i < 3; i++)
            { 
                // Assicura che i valori passati siano sempre non negativi
                this.AddMobile(this.Orcs, 6, Utility.RandomMinMax(0, 7), Utility.RandomMinMax(0, 7), 0);
            }
            this.AddMobile(new OrcCaptain(), 2, Utility.RandomMinMax(0, 7), Utility.RandomMinMax(0, 7), 0);
            ...
            this.AddMobile(this.m_Prisoner, 2, Utility.RandomMinMax(0, 2), Utility.RandomMinMax(0, 2), 0);
        }
