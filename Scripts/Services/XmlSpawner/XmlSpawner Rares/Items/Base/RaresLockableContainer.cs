...
{
	public abstract class RaresLockableContainer : RaresTrapableContainer, ILockable, ILockpickable
	{
		public override bool SmartSpawning{ get{ return false; } }
		...
		public RaresLockableContainer( int itemID ) : base( itemID )
		{
			m_MaxLockLevel = 100;
		}

		public RaresLockableContainer( Serial serial ) : base( serial )
		{
		}
