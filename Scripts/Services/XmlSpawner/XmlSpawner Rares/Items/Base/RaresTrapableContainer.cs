...
{
	public abstract class RaresTrapableContainer : RaresBaseContainer, ITelekinesisable
	{
		...
		public RaresTrapableContainer( int itemID ) : base( itemID )
		{
		}

		public RaresTrapableContainer( Serial serial ) : base( serial )
		{
		}
