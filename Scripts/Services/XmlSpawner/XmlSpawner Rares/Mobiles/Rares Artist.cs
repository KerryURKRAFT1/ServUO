...
{
	public class RaresArtist : RaresBaseNPC
	{
		...
		[Constructable]
		public RaresArtist() : base( AIType.AI_Thief, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
			...
			AddRares( new StealablePaintsAndBrush(), 3 ); // 25% chance
		}
		...
		public RaresArtist( Serial serial ) : base( serial )
		{
		}
