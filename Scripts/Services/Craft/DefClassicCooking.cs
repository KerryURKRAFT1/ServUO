...
namespace Server.Engines.Craft
{
    ...
    public class DefClassicCooking : CraftSystem
    {
        ...
        public static CraftSystem CraftSystem
        {
            get
            {
                if (m_CraftSystem == null)
                    m_CraftSystem = new DefClassicCooking();
        ...
        public override void InitCraftList()
        {
           ...
           //this.AddRes(index, typeof(SweetDough), 1044475, 1, 1044253);
            ...
            index = this.AddCraft(typeof(CakeMix), 1044495, 1041002, 0.0, 100.0, typeof(BowlFlour), 1044468, 1, 1044253);
            this.AddRes(index, typeof(SweetDough), 1044475, 1, 1044253);
