...
namespace Server.Items
{
	...
	public class DonaldTrumpVengance : BaseAxe
	{
		...
		public override float MlSpeed{ get{ return 2.50f; } }
	 	...
	 	[Constructable]
	 	public DonaldTrumpVengance() : base( 0xF45 )
	 	{
	 	 	Name = "DonaldTrump's Vengance";
	 	 	Hue = 1151;
	 	...
	 	public DonaldTrumpVengance(Serial serial) : base( serial )
	 	{
	 	}
