...
namespace Server.Gumps
{
    public class OzStaticToolGump : Gump
    {
        ...
        private static void OzThothsStatic_OnCommand(CommandEventArgs e)
        {
            ...
            from.CloseGump(typeof(OzStaticToolGump));
        ...
        {
            new CommandPair("Item ID", "Get ItemID"), 
            new CommandPair("Props", "Props"),
            new CommandPair("Wipe", "Wipe"), 
            new CommandPair("Delete", "Delete")
        };

        private static readonly CommandPair[] staticItemCommands = new CommandPair[]
        {
            new CommandPair("Anim", "AddAnimationStatic"), 
            new CommandPair("Arches", "AddArch"), 
            new CommandPair("Doors", "AddDoor"), 
            new CommandPair("Fences", "AddFence"),
            new CommandPair("Floors", "AddFloor"),
            new CommandPair("Food", "AddCookingStatic"),
            new CommandPair("Furniture", "AddFurniture"),
            new CommandPair("Gear", "AddGearStatic"), 
            new CommandPair("Ground", "AddGroundSt"), 
            new CommandPair("Light", "AddLightsStatic"),
            new CommandPair("Plants", "AddPlants"), 
            new CommandPair("Rocks", "AddRock"), 
            new CommandPair("Roofs", "AddRoof"),
            new CommandPair("Sign Post", "AddSignPStatic"), 
            new CommandPair("Signs", "AddSign"), 
            new CommandPair("Stairs", "AddStair"),
            new CommandPair("Walls", "AddWall"), 
            new CommandPair("Misc 1", "AddMiscStatic1"), 
            new CommandPair("Misc 2", "AddMiscStatic2"),
            /*,
			// We have no customs
            new CommandPair("Custom", "AddCustomsStatic")

          	//You can add 2 custom commands here or change the commands around a bit.
            new CommandPair("Custom Command", "AddCustomCommand"),
			new CommandPair("Custom Command", "AddCustomCommand")
          	*/
        };
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            if (!int.TryParse(info.TextEntries[0].Text, out HeightSingle))
            {
                HeightSingle = 1;
            }
            if (!int.TryParse(info.TextEntries[1].Text, out HeightArea))
            {
                HeightArea = 1;
            }
            if (!int.TryParse(info.TextEntries[2].Text, out DirectionSingle))
            {
                DirectionSingle = 1;
            }
            if (!int.TryParse(info.TextEntries[3].Text, out DirectionArea))
            {
                DirectionArea = 1;
            }
    ...
    public class MinimizedOzGump : Gump
    {
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                ...
                {
                    from.SendGump(new OzStaticToolGump());
                    from.CloseGump(typeof(MinimizedOzGump));
                    break;
                }
            }
        }
